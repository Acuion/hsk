...
var acHints = ['<div class="underlined">Снимаю шляпу</div>Совершить первое раскрытие за всю игру', '<div class="underlined">Цепная реакция</div>Совершить два раскрытия в течение 24 часов', '<div class="underlined">Рокировка</div>Раскрыть игрока имеющего большее количество раскрытий'];
var LKActive = false;
